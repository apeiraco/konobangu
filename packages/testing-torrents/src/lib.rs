...
pub async fn create_testcontainers() -> Result<TestingTorrentsInstance, testcontainers::TestcontainersError> {
  ...
  let container = GenericImage::new("ghcr.io/apeiraco/konobangu-testing-torrents", "latest")
    ...
    .with_prune_existed_label("konobangu", "testing-torrents", true, false)
    .await?;
